...
namespace TwitterClone.Controllers.Api
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(SignInManager<TwitterCloneUser> a_signInManager, UserManager<TwitterCloneUser> a_userManager, ILogger<UserController> a_logger, IEmailSender a_emailSender)
        {
        ...
        public async Task<JsonResult> Get(string userName)
        {
            ...
            var results = Mapper.Map<TwitterCloneUserViewModel>(await m_userManager.FindByIdAsync(user.Id));
            return Json(results);
        }
